...
public class DodgeSpecials implements AttackStrategy {
	...
	public DodgeSpecials(PokemonData pokemon, Move move1, Move move2, int extraDelay, DodgeStrategy dodgeStrategy, AttackDamage move1Damage, AttackDamage move2Damage) {
	...
	public static class DodgeSpecialsBuilder implements AttackStrategy.AttackStrategyBuilder<DodgeSpecials> {
		...
		@Override
		public DodgeSpecials build(PokemonData pokemon, DodgeStrategy dodgeStrategy, AttackDamage move1Damage, AttackDamage move2Damage, Random r) {
