...
class RankingParams {
    ...
    final private int numForTotal;
    public RankingParams(String attackerLevel, String defenderLevel, AttackStrategyType attackStrategy, AttackStrategyType defenseStrategy, RankingsSort sort, int numForTotal) {
        super();
